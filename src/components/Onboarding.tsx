...
const steps = [
  ...
  },
  {
    ...
    body: 'הציר מסודר בשורות לפי קטגוריה — מלכים, נביאים, חכמים, כהנים, לוחמים ומשפחה. כששתי רצועות חופפות, השניים חיו באותו זמן. לחיצה על דמות פותחת כרטיס ובו "מי חי בתקופתו?".',
  },
  {
    icon: Hourglass,
    title: 'הציר נפתח בהדרגה',
    body: 'במסך הראשון מוצגת רק התקופה הראשונה, כדי שהרצועות יהיו גדולות וברורות. כפתור "התקופה הבאה" מוסיף תקופה נוספת בכל לחיצה, ו"הצג את הכול" פותח את הציר כולו בבת אחת.',
  },
  {
    icon: null,
    title: 'לא ממציאים תאריכים',
    body: 'למקורות אין ציר תאריכים אחיד, ולכן לכל דמות מצוינת מידת הוודאות של מיקומה בזמן. על הציר: רצועה מלאה = ודאי, פסים = משוער, מסגרת מקווקוות = לא ניתן לקבוע.',
    legend: true,
  },
] as const;
